                                            ...
                                            <Fragment key={name}>
                                                ...
                                                {expandedEmployee === name && records.map(r => (
                                                    <tr key={r.id} style={{ backgroundColor: 'var(--gray-50)' }}>
                                                        ...
                                                        <td>
                                                            <span className="badge badge-success" style={{ fontSize: 12 }}>{r.timeIn}</span>
                                                            {r.type === 'bidding' && <span className="badge badge-info" style={{ fontSize: 10, marginLeft: 6 }}>Bidding</span>}
                                                        </td>
