                            ...
                            {filtered.length === 0 ? (
                                ...
                                filtered.map(emp => (
                                            ...
                                            >
                                                {editingId === emp.id ? (
                                                    <>
                                                        <td><input className="filter-input" value={editData.name} onChange={e => setEditData({ ...editData, name: e.target.value })} style={{ width: 120 }} /></td>
                                                        <td>{emp.email}</td>
                                                        <td><input className="filter-input" value={editData.idNumber} onChange={e => setEditData({ ...editData, idNumber: e.target.value })} style={{ width: 100 }} placeholder="Not set" /></td>
                                                        <td>
                                                            <select
                                                    ...
                                                    <>
                                                        ...
                                                        <td>
                                                            {emp.idNumber ? (
                                                                <span style={{ fontFamily: 'monospace', background: 'var(--gray-100)', padding: '2px 6px', borderRadius: 4, color: 'var(--gray-700)' }}>{emp.idNumber}</span>
                                                            ) : (
                                                                <span style={{ color: 'var(--gray-400)', fontStyle: 'italic', fontSize: '0.85rem' }}>None</span>
                                                            )}
                                                        </td>
