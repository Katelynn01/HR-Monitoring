...
import BiddingEvents from './pages/admin/BiddingEvents';
import PayrollEstimator from './pages/admin/PayrollEstimator';
  ...
  return (
    <Routes>
      ...
      <Route path="/admin" element={
        ...
        <Route path="bidding" element={<BiddingEvents />} />
      ...
      <Route path="/employee" element={
        ...
        <Route path="payroll" element={<PayrollEstimator />} />
        <Route path="profile" element={<EmployeeProfile />} />
      </Route>
